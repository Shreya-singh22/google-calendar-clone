      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-[#2d2e31] rounded-t-2xl sm:rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 w-full sm:max-w-lg max-h-[90dvh] flex flex-col overflow-hidden"
          >
            {/* Header */}
